import React, { useEffect, useState } from "react";import InputWithButton from "../../components/input-with-button/input-with-button";
			...
			.then((result) => {
				...
				result.data?.map((item) => {
					if (item?.mandatory != 0) {
						...
						// 	mandatoryQues.length
						// ) {
						// 	emptyans_id.push(item?.id);
						// 	mandatoryQues.push(item);
						// }
						emptyans_id.push(item?.id);
					} else {
