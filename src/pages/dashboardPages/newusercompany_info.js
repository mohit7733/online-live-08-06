import React, { useEffect, useRef, useState } from "react";import Left_menu from "../productpages/left_menu";
									...
									<div className="right">
										<div className="custom_dropdown form-group">
											<input
												...
												onChange={(e) => {
													if(e.target.value == "") {
														seterrorfield({...errorfield, timeZone: "required"})
												...
												style={
													errorfield.timeZone == "" ? {} : { borderBottom: "1px solid red" }
												}
											/>
