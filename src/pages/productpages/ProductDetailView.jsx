...
function ProductDetailView(props) {
	...
	console.log(sTime == "", "this is stime");
			...
			<div className="reset_resp  product_before_meeting">
				<div className="main">
					<Left_menu
						...
						showContact={
							productData?.checkrequest === 2 && state?.show_contact === 1
						}
													...
													<button
														...
														onClick={() => {
															if (
																...
																return false;
															} else if (isCompanyProfileFilled == false && localStorage.getItem("user_type") != "Supplier") {
																setTimeout(() => {
																	window.alert(
																		" You did not fill the company profile. Please fill the company profile to request a meeting."
																	);
																...
																setTimeout(() => {
																	window.alert(
																		" You did not fill the company information. Please fill the company information to request a meeting."
																	);
																	navigate("/company-information-fill", {
																		state: { company_info: 2 },
																	});
