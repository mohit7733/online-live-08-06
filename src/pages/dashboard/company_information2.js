                            ...
                            <div className="right">
                                <div className="form-group">
                                    {cInfo?.contact1_image && !editcompany?
                                        ...
                                        :
                                        <input type="file" name="contact1_image" onChange={onChangeValues} className="form-control" placeholder="Choose Profile Photo" onChange={onChangeValues} />
                                    }
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="right">
                                <div className="form-group">
                                    {cInfo?.contact2_image && !editcompany?
                                        ...
                                        :
                                        <input type="file" name="contact2_image" className="form-control" onChange={onChangeValues} placeholder="Choose Profile Photo" disabled={!editcompany} readOnly={editcompany} />
                                    }
                                </div>
                            </div>
                        </div>
